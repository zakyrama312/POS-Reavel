    ...
    return (
        <>
            <div className="flex items-center justify-between border-b p-4">
                ...
                <Button variant="outline" className="hidden cursor-pointer md:block">
                    Logout
                </Button>
            </div>
                ...
                <div className="flex-1 rounded-xl bg-white p-4 shadow">
                    <div className="flex justify-between">
                        <input
                            ...
                            className="mb-4 w-2/3 rounded border p-2"
                        />
                        <Button className="bg-red-500">Tambah Stok</Button>
                        <Button variant={'outline'} className="cursor-pointer hover:bg-red-500 hover:text-white">
                            Detail Penjualan
                        </Button>
                    </div>
